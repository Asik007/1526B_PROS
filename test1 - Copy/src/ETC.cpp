...
void intake_on(){
    intake.move_absolute(-370, 120);
}

void intake_rvr(){
    intake.move_absolute(0, 120);
...
ControllerButton btnY(ControllerDigital::down);
ControllerButton btnX(ControllerDigital::up);
...
// }
ControllerButton btnUP(ControllerDigital::X);
ControllerButton btnL(ControllerDigital::Y);
ControllerButton btnR(ControllerDigital::A);

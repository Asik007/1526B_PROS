...
// okapi::Motor Left_lift (Left_lift_port, Lift_rvr);

pros::Motor Right_lift (Right_lift_port, !Lift_rvr);
bool lift_state;
// bool prev_lift_state;

void autolift(int this2){
  // std::cout << "WTF";
  int motor_pwr = -3500*this2;
 std::cout << motor_pwr << "\n";
    Left_lift.move_absolute(motor_pwr,250);
    Right_lift.move_absolute(motor_pwr,250);

  // Left_lift.move_voltage(12000*this2);
  // Right_lift.move_voltage(12000*this2);
  // pros::delay(1000);
...
pros::ADIDigitalOut Claw_sol2 (claw_sol);

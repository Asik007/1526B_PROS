...
void autonomous() {
        ...
        .withDimensions({AbstractMotor::gearset::green,(36/72)} ,{{4_in, 12_in}, imev5GreenTPR})
		.withGains(
		...
		.withOdometry({{4.25_in, 12_in}, quadEncoderTPR}, StateMode::FRAME_TRANSFORMATION) // use the same scales as the chassis (above)
